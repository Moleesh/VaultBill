...
const desktopBridge: VaultBillDesktopBridge = {
  ...
  loadBuilderPackage: async (formatId) =>
    ipcRenderer.invoke('vaultbill:builder:load', formatId) as Promise<BuilderPackage | undefined>,
  listBuilderInventory: async () =>
    ipcRenderer.invoke('vaultbill:builder:inventory') as Promise<readonly BuilderInventoryItem[]>,

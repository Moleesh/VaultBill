...
export const SettingsPage: FC = () => {
    ...
    return (
        <div className="page-stack settings-page">
                    ...
                    <div className="settings-subsection">
                        <div className="section-heading">
                            <div>
                                ...
                                <p>
                                    Create a verified backup or restore one from a checked VaultBill
                                    archive.
                                </p>
                            </div>
                        ...
                        {capabilities.isLanBrowser &&
                        (capabilities.canBackup || capabilities.canRestore) ? (
                            <label>
                        ...
                        {!encryptBackup && capabilities.canBackup ? (
                            <p className="field-note">
                                Unencrypted backups are available when you need them, but VaultBill
                                recommends encrypted backups for normal use.
                            </p>
                        ) : null}
                    </div>
                    <div className="settings-subsection">
                        <div className="section-heading">
                            <div>
                                ...
                                <p>
                                    Encrypt new backups with a password protected by the desktop
                                    secure store.
                                </p>
                            </div>
                            <ShieldCheck aria-hidden="true" />
                    ...
                    <div className="settings-subsection danger-zone">
                        <div className="section-heading">
                            <div>
                                ...
                                <p>
                                    Remove all local business data, accounts, trial state, and
                                    activation.
                                </p>
                            </div>
                    ...
                    <div className="settings-subsection">
                        <div className="section-heading">
                            <div>
                                <h3>GST and GSP</h3>
                                <p>
                                    Keep tax helpers close to the invoice and builder settings they
                                    affect.
                                </p>
                            </div>
                            <ShieldCheck aria-hidden="true" />
                    ...
                    <div className="settings-subsection">
                        <div className="section-heading">
                            <div>
                                <h3>SMS provider</h3>
                                <p>
                                    Pick a starter provider or point VaultBill to your own gateway.
                                </p>
                            </div>
                            <ShieldCheck aria-hidden="true" />
                        </div>
            ...
            >
                <p>
                    The backup is checked and staged before the current database is replaced.
                    VaultBill restarts after a successful restore.
                </p>
                {capabilities.isLanBrowser ? (
                    <label>
            ...
            >
                <p>
                    Store this key separately from the backup. It can restore the backup if its

...
const renderConfiguredRecordHtml = (
    ...
    const values: Record<string, string> = {
        ...
        'Record.CreatedBy': stored?.createdBy ?? '',
        'Record.CreatedByName': stored?.createdByName ?? '',
        'Record.LastActionBy': stored?.lastActionBy ?? '',
        'Record.LastActionByName': stored?.lastActionByName ?? '',

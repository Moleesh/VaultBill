...
export type SqliteConnection = {
  ...
  readonly get: (sql: string, parameters?: readonly SqliteBindable[]) => SqliteRow | undefined;
  readonly all: (sql: string, parameters?: readonly SqliteBindable[]) => readonly SqliteRow[];
